...
class DroppablePage(BasePage):
    ...
    def drop_prevent_propogation(self):
        ...
        self.action_drag_and_drop_to_element(not_greedy_inner_box, drag_div)
        text_not_greedy_box = self.element_is_visible(self.locators.NOT_GREEDY_DROP_BOX_TEXT).text
        text_not_greedy_inner_box = not_greedy_inner_box
        ...
        return text_not_greedy_box, text_not_greedy_inner_box, text_greedy_inner_box, text_greedy_box

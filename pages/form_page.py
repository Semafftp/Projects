...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        # оставлю квик фикс если футер блокирует взаимодействие-> self.remove_footer() <-
        #     def remove_footer(self):
        #         self.driver.execute_script("document.getElementsByTagName('footer')[0].remove();")
        #         self.driver.execute_script("document.getElementsById('close-fixedban').remove();") for base_page
        ...
        self.element_is_visible(self.locators.SUBJECT).send_keys('Maths')  # взято из джс сайт

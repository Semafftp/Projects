...
class AutoCompletePage(BasePage):
    ...
    def fill_input_multi(self):
        ...
        for color in colors:  # выбор уникального элемента из сэта
    ...
    def check_color_in_multi(self):
        color_list = self.elements_are_present(self.locators.MULTI_INPUT)
        colors = []
...
class ToolTipsPage(BasePage):
    ...
    # добавление метода для проверки текста

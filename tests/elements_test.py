...
class TestElements:
    ...
    class TestWebTable:
        ...
        def test_web_table_delete_person(self, driver):
            ...
            web_table_page.delete_person()           #найдём надпись о том что ничего не найдено
        ...
        def test_web_table_change_count_row(self, driver):
            ...
            assert count == [5, 10, 20, 25, 50,
                             100], 'The number of rows in the table has not been changed incorrectly'
...
# добавления тестов на реквест
    ...
    class TestDynamicPropertiesPage:
        ...
        def test_dynamic_properties(self, driver):
            ...
            assert color_after != color_before, 'colors have not been changed'  # баг сайта

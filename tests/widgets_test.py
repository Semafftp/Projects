...
class TestWidgets:
    ...
    class TestProgressBarPage:
        ...
        def test_progress_bar(self, driver):
            ...
            assert before != after, 'the progressbar has not been changed'
    ...
    class TestMenuPage:
        ...
        def test_menu_items(self, driver):
            ...
            assert data == ['Main Item 1', 'Main Item 2', 'Sub Item', 'Sub Item', 'SUB SUB LIST »', 'Sub Sub Item 1',
                ...
                "menu items do not exist or have not been selected""menu items do not exist or have not been selected"
